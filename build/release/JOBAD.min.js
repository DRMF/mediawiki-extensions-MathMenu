...
var JOBAD=function(){var c,d=function(a){if(!(this instanceof d))return new d(a);var b=this;this.element=a;_.isElement(this.element)&&(this.element=$(this.element));this.element instanceof jQuery||d.error("Can't create JOBADInstance: Not a DOM Element. ");var e={},h=[];this.modules={};this.modules.load=function(a,c,h){if(!b.modules.loaded(a)){if("boolean"==typeof h&&h)d.modules.available(a)||d.error("Error loading module "+a),e[a]=new d.modules.loadedModule(a,c,b);else{h=d.modules.getDependencyList(a);
...
b.namespace[e]=a[e]);for(e in d.Events)a.hasOwnProperty(e)&&(b[e]=a[e]);return b}return!1};d.modules.available=function(a,b){b="boolean"==typeof b?b:!1;var e=n.hasOwnProperty(a);if(b&&e){for(var e=n[a].info.dependencies,c=0;c<e.length;c++)if(!d.modules.available(e[c],!0))return!1;return!0}return e};d.modules.getDependencyList=function(a){if(!d.modules.available(a,!0))return!1;var b=[a];a=n[a].info.dependencies;for(var e=a.length-1;0<=e;e--)b=_.union(b,d.modules.getDependencyList(a[e]));return b};
d.modules.loadedModule=function(a,b,e){d.modules.available(a)||d.error("Module is not available and cant be loaded. ");this.globalStore={get:function(b){return l[a][b+"_"]},set:function(b,e){l[a][b+"_"]=e},"delete":function(b){delete l[a][b+"_"]}};var c={};this.localStore={get:function(a){return c[a]},set:function(a,b){c[a]=b},"delete":function(){delete c[a]}};var f=n[a];this.info=function(){return f.info};this.getJOBAD=function(){return e};l[a].init||(l[a].init=!0,f.globalinit.apply(void 0,[]));
...
typeof a){var e={},c;for(c in a)e[c]=d.util.bindEverything(a[c],b);return e}return"function"==typeof a?_.bind(a,b):_.clone(a)};c=d;c.config.debug=!1;var p=[0,0];$(document).on("mousemove.JOBADListener",function(a){p=[a.pageX-$(window).scrollLeft(),a.pageY-$(window).scrollTop()]});c.UI={};c.UI.hover={};c.UI.hover.config={offsetX:10,offsetY:10};var q=!1,m=void 0;c.UI.hover.enable=function(a){q=!0;m=$("<div class='JOBAD JOBADHover'>").html(a).css({position:"fixed","background-color":"grey","-webkit-border-radius":5,
"-moz-border-radius":5,"border-radius":5,border:"1px solid black"});m.appendTo($("body"));$(document).on("mousemove.JOBAD.UI.hover",function(){c.UI.hover.refresh()});c.UI.hover.refresh();return!0};c.UI.hover.disable=function(){if(!q)return!1;q=!1;$(document).off("mousemove.JOBAD.UI.hover");m.remove()};c.UI.hover.refresh=function(){q&&m.css("top",Math.min(p[1]+c.UI.hover.config.offsetY,window.innerHeight-m.outerHeight(!0))).css("left",Math.min(p[0]+c.UI.hover.config.offsetX,window.innerWidth-m.outerWidth(!0)))};
c.UI.ContextMenu={};c.UI.ContextMenu.config={margin:20,width:250};c.UI.ContextMenu.enable=function(a,b,e,d){if("function"!=typeof b)return c.error("JOBAD.UI.ContextMenu.enable: demandFunction is not a function"),a;"function"!=typeof e&&(e=function(){});"function"!=typeof d&&(d=function(){});a.on("contextmenu.JOBAD.UI.ContextMenu",function(f){if(f.ctrlKey)return!0;var g=$(f.target);f=$(f.target);for(var k=!1;!(k=b(g,f))&&!a.is(this);)g=g.parent();if(!k)return!0;$(document).trigger("JOBADContextMenuUnbind");
e(a);var j=c.UI.ContextMenu.buildMenuList(k,g,f).menu().css({width:c.UI.ContextMenu.config.width,position:"fixed"}).on("contextmenu",function(){return!1}).on("mousedown",function(a){a.stopPropagation()}).appendTo($("body"));j.css("top",Math.min(p[1],window.innerHeight-j.outerHeight(!0)-c.UI.ContextMenu.config.margin)).css("left",Math.min(p[0],window.innerWidth-j.outerWidth(!0)-c.UI.ContextMenu.config.margin));$(document).on("JOBADContextMenuUnbind",function(){j.remove();d(a);$(document).unbind("mousedown.UI.ContextMenu.Unbind JOBADContextMenuUnbind")});
$(document).on("mousedown.UI.ContextMenu.Unbind",function(){$(document).trigger("JOBADContextMenuUnbind")});return!1});return a};c.UI.ContextMenu.disable=function(a){a.off("contextmenu.JOBAD.UI.ContextMenu");return a};c.UI.ContextMenu.buildMenuList=function(a,b,e){for(var d=$("<ul>"),f=0;f<a.length;f++){var g=a[f],k=$("<a href='#'>");$li=$("<li>").appendTo(d).append(k);k.text(g[0]).on("click",function(){return!1});(function(){if("function"==typeof g[1]){var a=g[1];k.on("click",function(){$(document).trigger("JOBADContextMenuUnbind");
a(b,e)})}else $li.append(c.UI.ContextMenu.buildMenuList(g[1],b,e))})()}return d};c.UI.Sidebar={};c.UI.Sidebar.config={width:100};c.UI.Sidebar.wrap=function(a){a=$(a);var b=$("<div>").css({overflow:"hidden"}),e=$("<div>").css({"float":"right",width:c.UI.Sidebar.config.width,height:1,position:"relative"}),d=$("<div>").css({width:"100%","float":"left",overflow:"hidden"});a.wrap(b);b=a.parent();b.wrap(d);d=b.parent();d.prepend(e);a.data("JOBAD.UI.Sidebar.active",!0);return a};c.UI.Sidebar.unwrap=function(a){a=
$(a);a.unwrap().parent().find("div").first().remove();a.removeData("JOBAD.UI.Sidebar.active");return a.unwrap()};c.UI.Sidebar.addNotification=function(a,b){var e=$(a),c=$(b),d=c.offset().top-e.offset().top,e=e.parent().parent().find("div").first(),g=$("<div>").css({position:"absolute",top:d}).appendTo(e),d=function(){var a=c.offset().top-e.offset().top;g.css({top:a})};$(window).on("resize.JOBAD.UI.Sidebar",d);return g.data("JOBAD.UI.Sidebar.ResizeHook",d)};c.UI.Sidebar.forceNotificationUpdate=function(){$(window).trigger("resize.JOBAD.UI.Sidebar")};
c.UI.Sidebar.removeNotification=function(a){var b=a.data("JOBAD.UI.Sidebar.ResizeHook");$(window).off("resize.JOBAD.UI.Sidebar",b);a.remove()};c.UI.highlight=function(a){a=$(a);a.data("JOBAD.UI.highlight.orgColor")&&a.css("backgroundColor",a.data("JOBAD.UI.highlight.orgColor"));a.stop().data("JOBAD.UI.highlight.orgColor",a.css("backgroundColor")).animate({backgroundColor:"#FFFF9C"},1E3)};c.UI.unhighlight=function(a){a=$(a);a.stop().animate({backgroundColor:a.data("JOBAD.UI.highlight.orgColor")},1E3).removeData("JOBAD.UI.highlight.orgColor")};
c.Events.leftClick={"default":function(){return!1},Setup:{enable:function(a){var b=this;a.delegate("*","click.JOBAD.leftClick",function(a){var c=$(a.target);switch(a.which){case 1:b.Event.leftClick.trigger(c),a.stopPropagation()}})},disable:function(a){a.undelegate("*","click.JOBAD.leftClick")}},namespace:{getResult:function(a){return this.modules.iterateAnd(function(b){b.leftClick.call(b,a,b.getJOBAD());return!0})},trigger:function(a){return this.Event.leftClick.getResult(a)}}};c.Events.contextMenuEntries=
...
$("<p>").text(d);else if("boolean"!=typeof d)try{b=jQuery(d)}catch(f){c.error("Module '"+e.info().identifier+"' returned invalid HOVER result. ")}else!0===d&&(b=!0);return!0});return b},trigger:function(a){if(a.data("JOBAD.hover.Active"))return!1;var b=this.Event.hoverText.getResult(a);if("boolean"==typeof b)return b;if(this.Event.hoverText.activeHoverElement instanceof jQuery){if(this.Event.hoverText.activeHoverElement.is(a))return!0;this.Event.hoverText.untrigger(this.Event.hoverText.activeHoverElement)}this.Event.hoverText.activeHoverElement=
a;a.data("JOBAD.hover.Active",!0);var d=window.setTimeout(function(){a.removeData("JOBAD.hover.timerId");c.UI.hover.enable(b.html())},c.config.hoverdelay);a.data("JOBAD.hover.timerId",d);return!0},untrigger:function(a){if("undefined"==typeof a)if(this.Event.hoverText.activeHoverElement instanceof jQuery)a=this.Event.hoverText.activeHoverElement;else return!1;if(!a.data("JOBAD.hover.Active"))return!1;"number"==typeof a.data("JOBAD.hover.timerId")&&(window.clearTimeout(a.data("JOBAD.hover.timerId")),
a.removeData("JOBAD.hover.timerId"));a.removeData("JOBAD.hover.Active");this.Event.hoverText.activeHoverElement=void 0;c.UI.hover.disable();return!a.is(this.element)?(this.Event.hoverText.trigger(a.parent()),!1):!0}}};c.Events.onSideBarUpdate={"default":function(){},Setup:{init:{Sidebar:{forceUpdate:function(){if(0==_.keys(this.Sidebar.Elements).length)this.element.data("JOBAD.UI.Sidebar.active")&&c.UI.Sidebar.unwrap(this.element);else{this.element.data("JOBAD.UI.Sidebar.active")||c.UI.Sidebar.wrap(this.element);
for(var a in this.Sidebar.Elements)this.Sidebar.Elements[a].data("JOBAD.Events.Sidebar.id")||(this.Sidebar.Elements[a]=c.UI.Sidebar.addNotification(this.element,this.Sidebar.Elements[a]))}c.UI.Sidebar.forceNotificationUpdate();this.Event.onSideBarUpdate.trigger()},registerNotification:function(a,b){a=$(a);var d=(new Date).getTime().toString();this.Sidebar.Elements[d]=a;this.Sidebar.forceUpdate();d=this.Sidebar.Elements[d].data("JOBAD.Events.Sidebar.id",d);d.data("JOBAD.Events.Sidebar.element",a);
b="undefined"==typeof b?{}:b;b.hasOwnProperty("text")&&d.text(b.text);b.trace&&d.hover(function(){c.UI.highlight(a)},function(){c.UI.unhighlight(a)});"function"==typeof b.callback&&d.click(b.callback);return d},removeNotification:function(a){if(a instanceof jQuery){var b=a.data("JOBAD.Events.Sidebar.id");c.UI.Sidebar.removeNotification(a);delete this.Sidebar.Elements[b];this.Sidebar.forceUpdate()}else c.error("JOABD Sidebar Error: Tried to remove invalid Element. ")}}},enable:function(){this.Sidebar.Elements=
{};this.Event.onSideBarUpdate.enabled=!0},disable:function(){this.Event.onSideBarUpdate.enabled=void 0}},namespace:{getResult:function(){this.Event.onSideBarUpdate.enabled&&this.modules.iterateAnd(function(a){a.onSideBarUpdate.call(a,a.getJOBAD());return!0})},trigger:function(){this.Event.onSideBarUpdate.getResult()}}};return c}();
