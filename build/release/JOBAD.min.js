...
*/
var JOBAD=function(){var b=function(a){if(!(this instanceof b))return new b(a);this.arguments=[];for(var d=0;d<arguments.length;d++)this.arguments.push(arguments[d]);this.element=a;b.refs._.isElement(this.element)&&(this.element=b.refs.$(this.element));this.element instanceof b.refs.$||b.error("Can't create JOBADInstance: Not a DOM Element. ");for(d=0;d<b.ifaces.length;d++){var c=b.ifaces[d];"function"==typeof c&&c.call(this,this,this.arguments)}};b.ifaces=[];b.version="3.0.0";b.toString=function(){return"function(/* JOBAD "+
b.version+" */){ [non-native non-trivial code] }"};b.config={debug:!0};b.console=_.isUndefined(console)?{log:function(){},warn:function(){},error:function(){}}:{log:function(a){b.config.debug&&console.log(a)},warn:function(a){b.config.debug&&console.warn(a)},error:function(a){b.config.debug&&console.error(a)}};b.error=function(a){b.console.error(a);throw Error(a);};b.refs={};b.refs.$=jQuery;b.refs._=_;b.noConflict=function(){return{_:b.noConflict._(),$:b.noConflict.$()}};b.noConflict.$=function(){b.refs.$=
b.refs.$.noConflict();return b.refs.$};b.noConflict._=function(){b.refs._=b.refs._.noConflict();return b.refs._};Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null==this)throw new TypeError;var b=Object(this),c=b.length>>>0;if(0===c)return-1;var e=0;1<arguments.length&&(e=Number(arguments[1]),e!=e?e=0:0!=e&&(Infinity!=e&&-Infinity!=e)&&(e=(0<e||-1)*Math.floor(Math.abs(e))));if(e>=c)return-1;for(e=0<=e?e:Math.max(c-Math.abs(e),0);e<c;e++)if(e in b&&b[e]===a)return e;return-1});b.util=
{};b.util.bindEverything=function(a,d){if(b.refs._.isObject(a)&&"function"!=typeof a){var c={},e;for(e in a)c[e]=b.util.bindEverything(a[e],d);return c}return"function"==typeof a?b.refs._.bind(a,d):b.refs._.clone(a)};b.ifaces.push(function(a){var d={},c=[];this.modules={};this.modules.load=function(c,f,g){if(!a.modules.loaded(c)){if("boolean"==typeof g&&g)b.modules.available(c)||b.error("Error loading module "+c),d[c]=new b.modules.loadedModule(c,f,a),d[c].onActivate(a);else{g=b.modules.getDependencyList(c);
if(!g)return b.console.warn("Unresolved dependencies for module '"+c+"'. "),!1;for(c=0;c<g.length;c++)a.modules.load(g[c],f,!0)}return!0}};this.modules.loaded=function(a){return d.hasOwnProperty(a)};this.modules.deactivate=function(e){a.modules.isActive(e)?(c.push(e),d[e].onDeactivate(a)):b.console.warn("Module '"+e+"' is already deactivated. ")};this.modules.activate=function(e){a.modules.isActive(e)?b.console.warn("Module '"+e+"' is already activated. "):(c=b.refs._.without(c,e),d[e].onActivate(a))};
this.modules.isActive=function(a){return-1==b.refs._.indexOf(c,a)};this.modules.getIdentifiers=function(){var a=[],b;for(b in d)d.hasOwnProperty(b)&&a.push(b);return a};this.modules.getLoadedModule=function(a){if(d.hasOwnProperty(a))return d[a];b.console.warn("Can't find JOBAD.modules.loadedModule instance of '"+a+"'")};this.modules.iterate=function(b){var c=[],g;for(g in d)if(d.hasOwnProperty(g)&&a.modules.isActive(g)){var h=b(d[g]);if(h)c.push(h);else break}return c};this.modules.iterateAnd=function(b){for(var c in d)if(d.hasOwnProperty(c)&&
a.modules.isActive(c)&&!b(d[c]))return!1;return!0}});b.modules={};b.modules.extensions={};b.modules.ifaces=[];b.modules.cleanProperties=["init","activate","deactivate","globalinit","info"];var p={},l={};b.modules.register=function(a){a=b.modules.createProperModuleObject(a);if(!a)return!1;var d=a.info.identifier;if(b.modules.available(d))return!1;p[d]=a;l[d]={};return!0};b.modules.createProperModuleObject=function(a){if(!b.refs._.isObject(a))return!1;var d={globalinit:function(){},init:function(){},
activate:function(){},deactivate:function(){}},c;for(c in d)if(d.hasOwnProperty(c)&&a.hasOwnProperty(c)){if("function"!=typeof a[c])return!1;d[c]=a[c]}if(a.hasOwnProperty("info")){var e=a.info;d.info={version:"",dependencies:[]};if(e.hasOwnProperty("version")){if("string"!=typeof e.version)return!1;d.info.version=e.version}d.info.hasCleanNamespace=e.hasOwnProperty("hasCleanNamespace")?!1==e.hasCleanNamespace?!1:!0:!0;if(e.hasOwnProperty("dependencies")){var f=e.dependencies;if(!b.refs._.isArray(f))return!1;
d.info.dependencies=f}try{b.refs._.map(["identifier","title","author","description"],function(a){if(e.hasOwnProperty(a)){var b=e[a];if("string"!=typeof b)throw"";d.info[a]=b}else throw"";})}catch(g){return!1}d.namespace={};for(c in a)a.hasOwnProperty(c)&&-1==b.modules.cleanProperties.indexOf(c)&&(d.info.hasCleanNamespace?b.console.warn("Warning: Module '"+d.info.identifier+"' says its namespace is clean, but property '"+c+"' found. Check ModuleObject.info.hasCleanNamespace. "):d.namespace[c]=a[c]);
for(var h=0;h<b.modules.ifaces.length;h++)f=b.modules.ifaces[h],d=f[0].call(this,d,a);for(c in b.modules.extensions){var f=b.modules.extensions[c],h=a.hasOwnProperty(c),j=a[c];f.required&&!h&&b.error("Error: Cannot load module '"+d.info.identifier+"'. Missing required core extension '"+c+"'. ");h&&(f.validate(j)||b.error("Error: Cannot load module '"+d.info.identifier+"'. Core Extension '"+c+"' failed to validate. "));d[c]=f.init(h,j,a,d)}return d}return!1};b.modules.available=function(a,d){d="boolean"==
typeof d?d:!1;var c=p.hasOwnProperty(a);if(d&&c){for(var c=p[a].info.dependencies,e=0;e<c.length;e++)if(!b.modules.available(c[e],!0))return!1;return!0}return c};b.modules.getDependencyList=function(a){if(!b.modules.available(a,!0))return!1;var d=[a];a=p[a].info.dependencies;for(var c=a.length-1;0<=c;c--)d=b.refs._.union(d,b.modules.getDependencyList(a[c]));return d};b.modules.loadedModule=function(a,d,c){b.modules.available(a)||b.error("Module is not available and cant be loaded. ");this.globalStore=
{get:function(b){return l[a][b+"_"]},set:function(b,c){l[a][b+"_"]=c},"delete":function(b){delete l[a][b+"_"]},keys:function(){var b=[],c;for(c in l[a])l[a].hasOwnProperty(c)&&"_"==c[c.length-1]&&b.push(c.substr(0,c.length-1));return b}};var e={};this.localStore={get:function(b){return e[b]},set:function(b,a){e[b]=a},"delete":function(){delete e[a]},keys:function(){var b=[],a;for(a in e)e.hasOwnProperty(a)&&b.push(a);return b}};var f=p[a];this.info=function(){return f.info};this.getJOBAD=function(){return c};
if(!l[a].init){l[a].init=!0;f.globalinit.apply(void 0,[]);for(var g in b.modules.extensions){var h=b.modules.extensions[g],j=f[g];if("function"==typeof h.onFirstLoad)h.onFirstLoad(this.globalStore)}}for(var k=[c],j=0;j<d.length;j++)k.push(d[j]);if(b.config.cleanModuleNamespace)f.info.hasCleanNamespace||b.console.warn("Warning: Module '"+a+"' may have unclean namespace, but JOBAD.config.cleanModuleNamespace is true. ");else for(g in d=b.refs._.clone(f.namespace),d)!b.modules.cleanProperties.hasOwnProperty(g)&&
d.hasOwnProperty(g)&&(this[g]=d[g]);for(g in b.modules.extensions)h=b.modules.extensions[g],j=f[g],"function"==typeof h.onLoad&&h.onLoad.call(this,j,f,this);for(j=0;j<b.modules.ifaces.length;j++)h=b.modules.ifaces[j],h[1].call(this,f);this.onActivate=f.activate;this.onDeactivate=f.deactivate;this.activate=function(){return c.modules.activate(this.info().identifier)};this.deactivate=function(){return c.modules.deactivate(this.info().identifier)};f.init.apply(this,k)};b.ifaces.push(function(a){this.Event=
{};this.Setup=function(){return a.Setup.enable()};this.Setup.enable=function(){var c=a.element,d;for(d in a.Event)b.Events[d].Setup.enable.call(a,c);return!0};this.Setup.disable=function(){return!1};for(var d in b.Events)if(b.Events.hasOwnProperty(d)&&!b.isEventDisabled(d))if(a.Event[d]=b.util.bindEverything(b.Events[d].namespace,a),"function"==typeof b.Events[d].Setup.init)b.Events[d].Setup.init.call(a,a);else if("object"==typeof b.Events[d].Setup.init)for(var c in b.Events[d].Setup.init)b.Events[d].Setup.init.hasOwnProperty(c)&&
(a.hasOwnProperty(c)?b.console.warn("Setup: Event '"+d+"' tried to override '"+c+"'"):a[c]=b.util.bindEverything(b.Events[d].Setup.init[c],a))});b.modules.ifaces.push([function(a,d){for(var c in b.Events)d.hasOwnProperty(c)&&(a[c]=d[c]);return a},function(a){for(var d in b.Events)this[d]=a.hasOwnProperty(d)?a[d]:b.Events[d]["default"]}]);b.isEventDisabled=function(a){return-1!=b.config.disabledEvents.indexOf(a)};b.Events={};b.config.disabledEvents=[];b.config.cleanModuleNamespace=!1;var q=[0,0];b.refs.$(document).on("mousemove.JOBADListener",
function(a){q=[a.pageX-b.refs.$(window).scrollLeft(),a.pageY-b.refs.$(window).scrollTop()]});b.UI={};b.UI.hover={};b.UI.hover.config={offsetX:10,offsetY:10,hoverDelay:1E3};var r=!1,n=void 0;b.UI.hover.enable=function(a,d){r=!0;n=b.refs.$("<div class='JOBAD'>").addClass(d).html(a);n.appendTo(b.refs.$("body"));b.refs.$(document).on("mousemove.JOBAD.UI.hover",function(){b.UI.hover.refresh()});b.UI.hover.refresh();return!0};b.UI.hover.disable=function(){if(!r)return!1;r=!1;b.refs.$(document).off("mousemove.JOBAD.UI.hover");
n.remove()};b.UI.hover.refresh=function(){r&&n.css("top",Math.min(q[1]+b.UI.hover.config.offsetY,window.innerHeight-n.outerHeight(!0))).css("left",Math.min(q[0]+b.UI.hover.config.offsetX,window.innerWidth-n.outerWidth(!0)))};b.UI.ContextMenu={};b.UI.ContextMenu.config={margin:20,width:250};b.UI.ContextMenu.enable=function(a,d,c,e){if("function"!=typeof d)return b.error("JOBAD.UI.ContextMenu.enable: demandFunction is not a function"),a;"function"!=typeof c&&(c=function(){});"function"!=typeof e&&(e=
function(){});a.on("contextmenu.JOBAD.UI.ContextMenu",function(f){if(f.ctrlKey)return!0;var g=b.refs.$(f.target);f=b.refs.$(f.target);for(var h=!1;!(h=d(g,f))&&!a.is(this);)g=g.parent();if(!h)return!0;b.refs.$(document).trigger("JOBADContextMenuUnbind");c(a);var j=b.UI.ContextMenu.buildMenuList(h,g,f).menu().css({width:b.UI.ContextMenu.config.width,position:"fixed"}).on("contextmenu",function(){return!1}).on("mousedown",function(b){b.stopPropagation()}).appendTo(b.refs.$("body"));j.css("top",Math.min(q[1],
window.innerHeight-j.outerHeight(!0)-b.UI.ContextMenu.config.margin)).css("left",Math.min(q[0],window.innerWidth-j.outerWidth(!0)-b.UI.ContextMenu.config.margin));b.refs.$(document).on("JOBADContextMenuUnbind",function(){j.remove();e(a);b.refs.$(document).unbind("mousedown.UI.ContextMenu.Unbind JOBADContextMenuUnbind")});b.refs.$(document).on("mousedown.UI.ContextMenu.Unbind",function(){b.refs.$(document).trigger("JOBADContextMenuUnbind")});return!1});return a};b.UI.ContextMenu.disable=function(b){b.off("contextmenu.JOBAD.UI.ContextMenu");
return b};b.UI.ContextMenu.buildMenuList=function(a,d,c){for(var e=b.refs.$("<ul class='JOBAD JOBAD_Contextmenu'>"),f=0;f<a.length;f++){var g=a[f],h=b.refs.$("<a href='#'>");$li=b.refs.$("<li>").appendTo(e).append(h);h.text(g[0]).on("click",function(){return!1});(function(){if("function"==typeof g[1]){var a=g[1];h.on("click",function(){b.refs.$(document).trigger("JOBADContextMenuUnbind");a(d,c)})}else $li.append(b.UI.ContextMenu.buildMenuList(g[1],d,c))})()}return e};b.UI.Sidebar={};b.UI.Sidebar.config=
{width:100,iconDistance:15,icons:{warning:"data:image/png;base64,",
...
b.UI.Sidebar.wrap=function(a){a=$(a);var d=b.refs.$("<div>").css({overflow:"hidden"}),c=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Container'>").css({width:b.UI.Sidebar.config.width}),e=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Wrapper'>");a.wrap(d);d=a.parent();d.wrap(e);e=d.parent();e.prepend(c);b.refs.$(window).on("resize.JOBAD.UI.Sidebar",function(){var a=c.find("*").filter(function(){return!0===b.refs.$(this).data("JOBAD.UI.Sidebar.isElement")});a.each(function(a,d){d=
b.refs.$(d).detach().appendTo(c).addClass("JOBAD_Sidebar_Single");var e=d.data("JOBAD.UI.Sidebar.orgElement").offset().top-c.offset().top;d.css({top:e,right:0})});for(var a=b.refs.$(a.sort(function(a,c){a=b.refs.$(a);c=b.refs.$(c);return parseInt(a.css("top"))<parseInt(c.css("top"))?-1:parseInt(a.css("top"))>parseInt(c.css("top"))?1:0})),d=a.eq(0),e=a.eq(1),j=[[d]],k=1;k<a.length;k++){var l=parseInt(d.css("top"));parseInt(e.css("top"))-(l+d.height())<b.UI.Sidebar.config.iconDistance?j[j.length-1].push(e):
(j.push([e]),d=e);e=a.eq(k+1)}b.refs.$(a).detach();c.find("*").remove();for(k=0;k<j.length;k++)1<j[k].length?function(){var a=b.refs.$(j[k]),d=parseInt(b.refs.$(a[0]).css("top")),d=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_group'><img src='"+b.UI.Sidebar.config.icons.multiple_open+"' width='16' height='16'></div>").css("top",d).appendTo(c),e=d.find("img"),f=!1;d.click(function(){if(f){for(var c=0;c<a.length;c++)a[c].hide();e.attr("src",b.UI.Sidebar.config.icons.multiple_open)}else{for(c=
0;c<a.length;c++)a[c].show();e.attr("src",b.UI.Sidebar.config.icons.multiple_close)}f=!f});for(var g=0;g<a.length;g++)b.refs.$(a[g]).appendTo(d).hide().removeClass("JOBAD_Sidebar_Single").addClass("JOBAD_Sidebar_group_element").css({right:20,top:-16})}():c.append(b.refs.$(j[k][0]).removeClass("JOBAD_Sidebar_group_element").show())});$(window).on("resize",function(){b.UI.Sidebar.forceNotificationUpdate()});a.data("JOBAD.UI.Sidebar.active",!0);return a};b.UI.Sidebar.unwrap=function(a){a=b.refs.$(a);
a.unwrap().parent().find("div").first().remove();a.removeData("JOBAD.UI.Sidebar.active");return a.unwrap()};b.UI.Sidebar.addNotification=function(a,d,c){c="undefined"==typeof c?{}:c;a=b.refs.$(a);var e=b.refs.$(d).offset().top-a.offset().top;a=a.parent().parent().find("div").first();var f=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Notification'>").css({top:e}).appendTo(a);f.data("JOBAD.UI.Sidebar.orgElement",d);f.data("JOBAD.UI.Sidebar.isElement",!0);if("undefined"!=typeof c.menu){var g=
b.util.fullWrap(c.menu,function(a){return a.apply(f,[d,c.menuThis])});b.UI.ContextMenu.enable(f,function(){return g})}c.hasOwnProperty("text")&&f.text(c.text);c.trace&&f.hover(function(){b.UI.highlight(d)},function(){b.UI.unhighlight(d)});"function"==typeof c.click&&f.click(c.click);a=!1;if("string"==typeof c["class"]){var h=c["class"];b.UI.Sidebar.config.icons.hasOwnProperty(h)&&(a=b.UI.Sidebar.config.icons[h])}"string"==typeof c.icon&&(a=c.icon);"string"==typeof a?f.html("<img src='"+a+"' width='16px' height='16px'>").hover(function(){b.UI.hover.enable(b.refs.$("<div>").text(c.text).html(),
"JOBAD_Sidebar_Hover JOBAD_Sidebar "+("string"==typeof c["class"]?" JOBAD_Notification_"+c["class"]:""))},function(){b.UI.hover.disable()}):f.addClass("JOBAD_Notification_"+h);return f};b.UI.Sidebar.forceNotificationUpdate=function(){b.refs.$(window).trigger("resize.JOBAD.UI.Sidebar")};b.UI.Sidebar.removeNotification=function(a){a.remove()};b.UI.highlight=function(a){a=b.refs.$(a);var d;d="string"==typeof a.data("JOBAD.UI.highlight.orgColor")?a.data("JOBAD.UI.highlight.orgColor"):a.css("backgroundColor");
a.stop().data("JOBAD.UI.highlight.orgColor",d).animate({backgroundColor:"#FFFF9C"},1E3)};b.UI.unhighlight=function(a){a=b.refs.$(a);a.stop().animate({backgroundColor:a.data("JOBAD.UI.highlight.orgColor"),finish:function(){a.removeData("JOBAD.UI.highlight.orgColor")}},1E3)};b.Events.leftClick={"default":function(){return!1},Setup:{enable:function(a){var d=this;a.delegate("*","click.JOBAD.leftClick",function(c){var e=b.refs.$(c.target);switch(c.which){case 1:d.Event.leftClick.trigger(e),c.stopPropagation()}a.trigger("JOBAD.Event",
["leftClick",e])})},disable:function(a){a.undelegate("*","click.JOBAD.leftClick")}},namespace:{getResult:function(a){return this.modules.iterateAnd(function(b){b.leftClick.call(b,a,b.getJOBAD());return!0})},trigger:function(a){return this.Event.leftClick.getResult(a)}}};b.Events.onEvent={"default":function(){},Setup:{enable:function(a){var b=this;a.on("JOBAD.Event",function(a,e,f){b.Event.onEvent.trigger(e,f)})},disable:function(a){a.off("JOBAD.Event")}},namespace:{getResult:function(a,b){return this.modules.iterateAnd(function(c){c.onEvent.call(c,
a,b,c.getJOBAD());return!0})},trigger:function(a,b){return this.Event.onEvent.getResult(a,b)}}};b.Events.contextMenuEntries={"default":function(){return[]},Setup:{enable:function(a){var d=this;b.UI.ContextMenu.enable(a,function(b){var e=d.Event.contextMenuEntries.getResult(b);a.trigger("JOBAD.Event",["contextMenuEntries",b]);return e})},disable:function(a){b.UI.ContextMenu.disable(a)}},namespace:{getResult:function(a){for(var d=[],c=this.modules.iterate(function(c){c=c.contextMenuEntries.call(c,a,
c.getJOBAD());return b.refs._.isArray(c)?c:b.util.generateMenuList(c)}),e=0;e<c.length;e++)for(var f=c[e],g=0;g<f.length;g++)d.push(f[g]);return 0==d.length?!1:d}}};b.util.generateMenuList=function(a){if("undefined"==typeof a)return[];var d=[],c;for(c in a)if(a.hasOwnProperty(c)){var e=a[c];"function"==typeof e?d.push([c,e]):d.push([c,b.util.generateMenuList(e)])}return d};b.util.fullWrap=function(a,d){a=b.refs._.isArray(a)?a:b.util.generateMenuList(a);for(var c=[],e=0;e<a.length;e++)"function"==
typeof a[e][1]?function(){var b=a[e][1];c.push([a[e][0],function(){return d(b,arguments)}])}():c.push([a[e][0],b.util.fullWrap(a[e][1])]);return c};b.Events.hoverText={"default":function(){return!1},Setup:{init:function(){this.Event.hoverText.activeHoverElement=void 0},enable:function(a){var d=this;a.delegate("*","mouseenter.JOBAD.hoverText",function(c){var e=b.refs.$(this);d.Event.hoverText.trigger(e)?c.stopPropagation():e.is(a)||b.refs.$(this).parent().trigger("mouseenter.JOBAD.hoverText",c);a.trigger("JOBAD.Event",
["hoverText",e]);return!1}).delegate("*","mouseleave.JOBAD.hoverText",function(){return d.Event.hoverText.untrigger(b.refs.$(this))})},disable:function(a){"undefined"!=typeof this.Event.hoverText.activeHoverElement&&me.Event.hoverText.untrigger();a.undelegate("*","mouseenter.JOBAD.hoverText").undelegate("*","mouseleave.JOBAD.hoverText")}},namespace:{getResult:function(a){var d=!1;this.modules.iterate(function(c){var e=c.hoverText.call(c,a,c.getJOBAD());if("undefined"!=typeof e&&"boolean"==typeof d)if("string"==
typeof e)d=b.refs.$("<p>").text(e);else if("boolean"!=typeof e)try{d=b.refs.$(e)}catch(f){b.error("Module '"+c.info().identifier+"' returned invalid HOVER result. ")}else!0===e&&(d=!0);return!0});return d},trigger:function(a){if(a.data("JOBAD.hover.Active"))return!1;var d=this.Event.hoverText.getResult(a);if("boolean"==typeof d)return d;if(this.Event.hoverText.activeHoverElement instanceof b.refs.$){if(this.Event.hoverText.activeHoverElement.is(a))return!0;this.Event.hoverText.untrigger(this.Event.hoverText.activeHoverElement)}this.Event.hoverText.activeHoverElement=
a;a.data("JOBAD.hover.Active",!0);var c=window.setTimeout(function(){a.removeData("JOBAD.hover.timerId");b.UI.hover.enable(d.html(),"JOBAD_Hover")},b.UI.hover.config.hoverDelay);a.data("JOBAD.hover.timerId",c);return!0},untrigger:function(a){if("undefined"==typeof a)if(this.Event.hoverText.activeHoverElement instanceof b.refs.$)a=this.Event.hoverText.activeHoverElement;else return!1;if(!a.data("JOBAD.hover.Active"))return!1;"number"==typeof a.data("JOBAD.hover.timerId")&&(window.clearTimeout(a.data("JOBAD.hover.timerId")),
a.removeData("JOBAD.hover.timerId"));a.removeData("JOBAD.hover.Active");this.Event.hoverText.activeHoverElement=void 0;b.UI.hover.disable();return!a.is(this.element)?(this.Event.hoverText.trigger(a.parent()),!1):!0}}};b.Events.onSideBarUpdate={"default":function(){},Setup:{init:{Sidebar:{redraw:function(){"undefined"==typeof this.Sidebar.Elements&&(this.Sidebar.Elements={});if(0==b.refs._.keys(this.Sidebar.Elements).length)this.element.data("JOBAD.UI.Sidebar.active")&&b.UI.Sidebar.unwrap(this.element);
else{this.element.data("JOBAD.UI.Sidebar.active")||b.UI.Sidebar.wrap(this.element);for(var a in this.Sidebar.Elements){var d=this.Sidebar.Elements[a];d.data("JOBAD.Events.Sidebar.id")||(this.Sidebar.Elements[a]=b.UI.Sidebar.addNotification(this.element,this.Sidebar.Elements[a],d.data("JOBAD.Events.Sidebar.config")))}}b.UI.Sidebar.forceNotificationUpdate();this.Event.onSideBarUpdate.trigger()},registerNotification:function(a,d){"undefined"==typeof this.Sidebar.Elements&&(this.Sidebar.Elements={});
a=b.refs.$(a);var c=(new Date).getTime().toString();d="undefined"==typeof d?{}:d;d.menuThis=this;this.Sidebar.Elements[c]=a.data("JOBAD.Events.Sidebar.config",d);this.Sidebar.redraw();c=this.Sidebar.Elements[c].data("JOBAD.Events.Sidebar.id",c);c.data("JOBAD.Events.Sidebar.element",a);return c},removeNotification:function(a){if(a instanceof b.refs.$){var d=a.data("JOBAD.Events.Sidebar.id");b.UI.Sidebar.removeNotification(a);delete this.Sidebar.Elements[d];this.Sidebar.redraw()}else b.error("JOBAD Sidebar Error: Tried to remove invalid Element. ")}}},
enable:function(){this.Event.onSideBarUpdate.enabled=!0},disable:function(){this.Event.onSideBarUpdate.enabled=void 0}},namespace:{getResult:function(){this.Event.onSideBarUpdate.enabled&&this.modules.iterateAnd(function(a){a.onSideBarUpdate.call(a,a.getJOBAD());return!0})},trigger:function(){this.Event.onSideBarUpdate.getResult()}}};for(var s in b.Events)b.modules.cleanProperties.push(s);b.storageBackend={getKey:function(a,d){var c=b.storageBackend.engines[b.config.storageBackend][0](a);return"string"==
typeof c?JSON.parse(c):d},setKey:function(a,d){return b.storageBackend.engines[b.config.storageBackend][1](a,JSON.stringify(d))}};b.storageBackend.engines={none:[function(){},function(){}]};b.config.storageBackend="none";b.util.validateConfigSetting=function(a,d,c){if(!a.hasOwnProperty(d))return b.console.warn("Undefined user setting: "+d),!1;var e=a[d][0];a=a[d][1];switch(e){case "string":return"string"!=typeof c?!1:b.refs._.isRegExp(a)?a.test(c):"function"==typeof a?a(c):!0;case "bool":return"boolean"==
typeof c;case "integer":return"number"!=typeof c||0!=c%1?!1:"function"==typeof a?a(c):b.refs._.isArray(a)?c>=a[0]&&c<=a[1]:!0;case "number":return"number"!=typeof c?!1:"function"==typeof a?a(c):b.refs._.isArray(a)?c>=a[0]&&c<=a[1]:!0;case "list":return-1!=a.indexOf(c);default:b.console.warn("Unknown configuration type '"+e+"' for user setting '"+d+"'")}};b.util.getDefaultConfigSetting=function(a,d){if(a.hasOwnProperty(d)){var c=a[d][2];if(b.util.validateConfigSetting(a,d,c))return c;b.console.warn("Undefined user setting: "+
a)}else b.console.warn("Undefined user setting: "+d)};var m={};b.modules.extensions.config={required:!1,validate:function(){return!0},init:function(a,b){return a?b:{}},onLoad:function(a,d){var c=d.info.identifier;this.UserConfig={};this.UserConfig.set=function(a,d){this.UserConfig.canSet(a,d)?m[c][a]=d:b.console.warn("Can not set user config '"+a+"': Validation failure. ");b.storageBackend.setKey(c,m[c])};this.UserConfig.canSet=function(c,d){return b.util.validateConfigSetting(a,c,d)};this.UserConfig.get=
function(d){var f=m[c][d];if(b.util.validateConfigSetting(a,d,f))return f;b.console.log("Failed to access user setting '"+d+"'")};this.UserConfig.getTypes=function(){return JOBAd.refs._.clone(a)};this.UserConfig.reset=function(){m[c]=b.storageBackend.getKey(c);if("undefined"==typeof m[c]){m[c]={};for(var d in a)m[c][d]=b.util.getDefaultConfigSetting(a,d)}};m.hasOwnProperty(c)||this.UserConfig.reset()}};for(s in b.modules.extensions)b.modules.cleanProperties.push(s);return b}();
