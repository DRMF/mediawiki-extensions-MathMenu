...
typeof c?JSON.parse(c):d},setKey:function(a,d){return b.storageBackend.engines[b.config.storageBackend][1](a,JSON.stringify(d))}};b.storageBackend.engines={none:[function(){},function(){}]};var m={};b.config.storageBackend="none";b.util.validateConfigSetting=function(a,d,c){if(!a.hasOwnProperty(d))return b.console.warn("Undefined user setting: "+d),!1;var e=a[d][0];a=a[d][1];switch(e){case "string":return"string"!=typeof c?!1:b.refs._.isRegExp(a)?a.test(c):"function"==typeof a?a(c):!0;case "bool":return"boolean"==
