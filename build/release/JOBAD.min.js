...
*/
var JOBAD=function(){var b,c=function(a){if(!(this instanceof c))return new c(a);var e=this;e.arguments=[];for(var b=0;b<arguments.length;b++)e.arguments.push(arguments[b]);this.element=a;c.refs._.isElement(this.element)&&(this.element=c.refs.$(this.element));this.element instanceof c.refs.$||c.error("Can't create JOBADInstance: Not a DOM Element. ");var d={},f=[];this.modules={};this.modules.load=function(a,b,g){if(!e.modules.loaded(a)){if("boolean"==typeof g&&g)c.modules.available(a)||c.error("Error loading module "+
a),d[a]=new c.modules.loadedModule(a,b,e);else{g=c.modules.getDependencyList(a);if(!g)return c.console.warn("Unresolved dependencies for module '"+a+"'. "),!1;for(a=0;a<g.length;a++)e.modules.load(g[a],b,!0)}return!0}};this.modules.loaded=function(a){return d.hasOwnProperty(a)};this.modules.deactivate=function(a){e.modules.isActive(a)?c.warn("Module '"+a+"' is already deactivated. "):f.push(a)};this.modules.activate=function(a){e.modules.isActive(a)?c.warn("Module '"+a+"' is already activated. "):
f=c.refs._.without(f,a)};this.modules.isActive=function(a){return-1==c.refs._.indexOf(f,a)};this.modules.iterate=function(a){var b=[],g;for(g in d)if(d.hasOwnProperty(g)&&e.modules.isActive(g)){var c=a(d[g]);if(c)b.push(c);else break}return b};this.modules.iterateAnd=function(a){for(var b in d)if(d.hasOwnProperty(b)&&e.modules.isActive(b)&&!a(d[b]))return!1;return!0};this.Event={};this.Setup=function(){return e.Setup.enable()};this.Setup.enable=function(){var a=e.element,b;for(b in e.Event)c.Events[b].Setup.enable.call(e,
a);return!0};this.Setup.disable=function(){return!1};for(var h in c.extensions)b=c.extensions[h],"function"==typeof b.onJOBADinit&&b.onJOBADinit.apply(this,this.arguments);for(h in c.Events)if(c.Events.hasOwnProperty(h)&&!c.isEventDisabled(h))if(e.Event[h]=c.util.bindEverything(c.Events[h].namespace,e),"function"==typeof c.Events[h].Setup.init)c.Events[h].Setup.init.call(e,e);else if("object"==typeof c.Events[h].Setup.init)for(var j in c.Events[h].Setup.init)c.Events[h].Setup.init.hasOwnProperty(j)&&
(e.hasOwnProperty(j)?c.console.warn("Setup: Event '"+h+"' tried to override '"+j+"'"):e[j]=c.util.bindEverything(c.Events[h].Setup.init[j],e))};c.version="3.0.0";c.config={debug:!0,cleanModuleNamespace:!1,disabledEvents:[]};c.Events={};c.isEventDisabled=function(a){return-1!=c.config.disabledEvents.indexOf(a)};c.console=_.isUndefined(console)?{log:function(){},warn:function(){},error:function(){}}:{log:function(a){c.config.debug&&console.log(a)},warn:function(a){c.config.debug&&console.warn(a)},error:function(a){c.config.debug&&
console.error(a)}};c.error=function(a){c.console.error(a);throw Error(a);};c.modules={};c.extensions={};var n={},m={};c.modules.register=function(a){a=c.modules.createProperModuleObject(a);if(!a)return!1;var e=a.info.identifier;if(c.modules.available(e))return!1;n[e]=a;m[e]={};return!0};c.modules.createProperModuleObject=function(a){if(!c.refs._.isObject(a))return!1;var e={globalinit:function(){},init:function(){}},b;for(b in e)if(e.hasOwnProperty(b)&&a.hasOwnProperty(b)){if("function"!=typeof a[b])return!1;
e[b]=a[b]}if(a.hasOwnProperty("info")){var d=a.info;e.info={version:"",dependencies:[]};if(d.hasOwnProperty("version")){if("string"!=typeof d.version)return!1;e.info.version=d.version}e.info.hasCleanNamespace=d.hasOwnProperty("hasCleanNamespace")?!1==d.hasCleanNamespace?!1:!0:!0;if(d.hasOwnProperty("dependencies")){var f=d.dependencies;if(!c.refs._.isArray(f))return!1;e.info.dependencies=f}try{c.refs._.map(["identifier","title","author","description"],function(a){if(d.hasOwnProperty(a)){var b=d[a];
if("string"!=typeof b)throw"";e.info[a]=b}else throw"";})}catch(h){return!1}f=["info","globalinit","init"];e.namespace={};for(b in a)a.hasOwnProperty(b)&&(-1==f.indexOf(b)&&!c.Events.hasOwnProperty(b)&&!c.extensions.hasOwnProperty(b))&&(e.info.hasCleanNamespace?c.console.warn("Warning: Module '"+e.info.identifier+"' says its namespace is clean, but property '"+b+"' found. Check ModuleObject.info.hasCleanNamespace. "):e.namespace[b]=a[b]);for(b in c.Events)a.hasOwnProperty(b)&&(e[b]=a[b]);for(b in c.extensions){var f=
c.extensions[b],j=a.hasOwnProperty(b),k=a[b];f.required&&!j&&c.error("Error: Cannot load module '"+e.info.identifier+"'. Missing required core extension '"+b+"'. ");j&&(f.validate(k)||c.error("Error: Cannot load module '"+e.info.identifier+"'. Core Extension '"+b+"' failed to validate. "));e[b]=f.init(j,k,a,e)}return e}return!1};c.modules.available=function(a,b){b="boolean"==typeof b?b:!1;var g=n.hasOwnProperty(a);if(b&&g){for(var g=n[a].info.dependencies,d=0;d<g.length;d++)if(!c.modules.available(g[d],
!0))return!1;return!0}return g};c.modules.getDependencyList=function(a){if(!c.modules.available(a,!0))return!1;var b=[a];a=n[a].info.dependencies;for(var g=a.length-1;0<=g;g--)b=c.refs._.union(b,c.modules.getDependencyList(a[g]));return b};c.modules.loadedModule=function(a,b,g){c.modules.available(a)||c.error("Module is not available and cant be loaded. ");this.globalStore={get:function(b){return m[a][b+"_"]},set:function(b,e){m[a][b+"_"]=e},"delete":function(b){delete m[a][b+"_"]},keys:function(){var b=
[],e;for(e in m[a])m[a].hasOwnProperty(e)&&"_"==e[e.length-1]&&b.push(e.substr(0,e.length-1));return b}};var d={};this.localStore={get:function(a){return d[a]},set:function(a,b){d[a]=b},"delete":function(){delete d[a]},keys:function(){var a=[],b;for(b in d)d.hasOwnProperty(b)&&a.push(b);return a}};var f=n[a];this.info=function(){return f.info};this.getJOBAD=function(){return g};if(!m[a].init){m[a].init=!0;f.globalinit.apply(void 0,[]);for(var h in c.extensions){var j=c.extensions[h],k=f[h];if("function"==
typeof j.onFirstLoad)j.onFirstLoad(k,this.globalStore)}}for(var l=[g],j=0;j<b.length;j++)l.push(b[j]);if(c.config.cleanModuleNamespace)f.info.hasCleanNamespace||c.console.warn("Warning: Module '"+a+"' may have unclean namespace, but JOBAD.config.cleanModuleNamespace is true. ");else for(h in b=c.refs._.clone(f.namespace),b)!c.Events.hasOwnProperty(h)&&b.hasOwnProperty(h)&&(this[h]=b[h]);for(h in c.extensions)if(j=c.extensions[h],k=f[h],"function"==typeof j.onLoad)j.onLoad(k,f,this);for(h in c.Events)this[h]=
f.hasOwnProperty(h)?f[h]:c.Events[h]["default"];f.init.apply(this,l)};c.util={};c.util.bindEverything=function(a,b){if(c.refs._.isObject(a)&&"function"!=typeof a){var g={},d;for(d in a)g[d]=c.util.bindEverything(a[d],b);return g}return"function"==typeof a?c.refs._.bind(a,b):c.refs._.clone(a)};c.refs={};c.refs.$=jQuery;c.refs._=_;c.noConflict=function(){return{_:c.noConflict._(),$:c.noConflict.$()}};c.noConflict.$=function(){c.refs.$=c.refs.$.noConflict();return c.refs.$};c.noConflict._=function(){c.refs._=
c.refs._.noConflict();return c.refs._};Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null==this)throw new TypeError;var b=Object(this),c=b.length>>>0;if(0===c)return-1;var d=0;1<arguments.length&&(d=Number(arguments[1]),d!=d?d=0:0!=d&&(Infinity!=d&&-Infinity!=d)&&(d=(0<d||-1)*Math.floor(Math.abs(d))));if(d>=c)return-1;for(d=0<=d?d:Math.max(c-Math.abs(d),0);d<c;d++)if(d in b&&b[d]===a)return d;return-1});c.toString=function(){return"function(/* JOBAD v3 */){ [non-native non-trivial code] }"};
b=c;var p=[0,0];b.refs.$(document).on("mousemove.JOBADListener",function(a){p=[a.pageX-b.refs.$(window).scrollLeft(),a.pageY-b.refs.$(window).scrollTop()]});b.UI={};b.UI.hover={};b.UI.hover.config={offsetX:10,offsetY:10,hoverDelay:1E3};var q=!1,l=void 0;b.UI.hover.enable=function(a,e){q=!0;l=b.refs.$("<div class='JOBAD'>").addClass(e).html(a);l.appendTo(b.refs.$("body"));b.refs.$(document).on("mousemove.JOBAD.UI.hover",function(){b.UI.hover.refresh()});b.UI.hover.refresh();return!0};b.UI.hover.disable=
function(){if(!q)return!1;q=!1;b.refs.$(document).off("mousemove.JOBAD.UI.hover");l.remove()};b.UI.hover.refresh=function(){q&&l.css("top",Math.min(p[1]+b.UI.hover.config.offsetY,window.innerHeight-l.outerHeight(!0))).css("left",Math.min(p[0]+b.UI.hover.config.offsetX,window.innerWidth-l.outerWidth(!0)))};b.UI.ContextMenu={};b.UI.ContextMenu.config={margin:20,width:250};b.UI.ContextMenu.enable=function(a,e,c,d){if("function"!=typeof e)return b.error("JOBAD.UI.ContextMenu.enable: demandFunction is not a function"),
a;"function"!=typeof c&&(c=function(){});"function"!=typeof d&&(d=function(){});a.on("contextmenu.JOBAD.UI.ContextMenu",function(f){if(f.ctrlKey)return!0;var h=b.refs.$(f.target);f=b.refs.$(f.target);for(var j=!1;!(j=e(h,f))&&!a.is(this);)h=h.parent();if(!j)return!0;b.refs.$(document).trigger("JOBADContextMenuUnbind");c(a);var k=b.UI.ContextMenu.buildMenuList(j,h,f).menu().css({width:b.UI.ContextMenu.config.width,position:"fixed"}).on("contextmenu",function(){return!1}).on("mousedown",function(a){a.stopPropagation()}).appendTo(b.refs.$("body"));
k.css("top",Math.min(p[1],window.innerHeight-k.outerHeight(!0)-b.UI.ContextMenu.config.margin)).css("left",Math.min(p[0],window.innerWidth-k.outerWidth(!0)-b.UI.ContextMenu.config.margin));b.refs.$(document).on("JOBADContextMenuUnbind",function(){k.remove();d(a);b.refs.$(document).unbind("mousedown.UI.ContextMenu.Unbind JOBADContextMenuUnbind")});b.refs.$(document).on("mousedown.UI.ContextMenu.Unbind",function(){b.refs.$(document).trigger("JOBADContextMenuUnbind")});return!1});return a};b.UI.ContextMenu.disable=
function(a){a.off("contextmenu.JOBAD.UI.ContextMenu");return a};b.UI.ContextMenu.buildMenuList=function(a,e,c){for(var d=b.refs.$("<ul class='JOBAD JOBAD_Contextmenu'>"),f=0;f<a.length;f++){var h=a[f],j=b.refs.$("<a href='#'>");$li=b.refs.$("<li>").appendTo(d).append(j);j.text(h[0]).on("click",function(){return!1});(function(){if("function"==typeof h[1]){var a=h[1];j.on("click",function(){b.refs.$(document).trigger("JOBADContextMenuUnbind");a(e,c)})}else $li.append(b.UI.ContextMenu.buildMenuList(h[1],
e,c))})()}return d};b.UI.Sidebar={};b.UI.Sidebar.config={width:100,icons:{warning:"data:image/png;base64,",
...
b.UI.Sidebar.wrap=function(a){a=$(a);var e=b.refs.$("<div>").css({overflow:"hidden"}),c=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Container'>").css({width:b.UI.Sidebar.config.width}),d=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Wrapper'>");a.wrap(e);e=a.parent();e.wrap(d);d=e.parent();d.prepend(c);a.data("JOBAD.UI.Sidebar.active",!0);return a};b.UI.Sidebar.unwrap=function(a){a=b.refs.$(a);a.unwrap().parent().find("div").first().remove();a.removeData("JOBAD.UI.Sidebar.active");
return a.unwrap()};b.UI.Sidebar.addNotification=function(a,e){var c=b.refs.$(a),d=b.refs.$(e),f=d.offset().top-c.offset().top,c=c.parent().parent().find("div").first(),h=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Notification'>").css({top:f}).appendTo(c),f=function(){var a=d.offset().top-c.offset().top;h.css({top:a})};b.refs.$(window).on("resize.JOBAD.UI.Sidebar",f);return h.data("JOBAD.UI.Sidebar.ResizeHook",f)};b.UI.Sidebar.forceNotificationUpdate=function(){b.refs.$(window).trigger("resize.JOBAD.UI.Sidebar")};
b.UI.Sidebar.removeNotification=function(a){var e=a.data("JOBAD.UI.Sidebar.ResizeHook");b.refs.$(window).off("resize.JOBAD.UI.Sidebar",e);a.remove()};b.UI.highlight=function(a){a=b.refs.$(a);var e;e="string"==typeof a.data("JOBAD.UI.highlight.orgColor")?a.data("JOBAD.UI.highlight.orgColor"):a.css("backgroundColor");a.stop().data("JOBAD.UI.highlight.orgColor",e).animate({backgroundColor:"#FFFF9C"},1E3)};b.UI.unhighlight=function(a){a=b.refs.$(a);a.stop().animate({backgroundColor:a.data("JOBAD.UI.highlight.orgColor"),
finish:function(){a.removeData("JOBAD.UI.highlight.orgColor")}},1E3)};b.Events.leftClick={"default":function(){return!1},Setup:{enable:function(a){var e=this;a.delegate("*","click.JOBAD.leftClick",function(c){var d=b.refs.$(c.target);switch(c.which){case 1:e.Event.leftClick.trigger(d),c.stopPropagation()}a.trigger("JOBAD.Event",["leftClick",d])})},disable:function(a){a.undelegate("*","click.JOBAD.leftClick")}},namespace:{getResult:function(a){return this.modules.iterateAnd(function(b){b.leftClick.call(b,
a,b.getJOBAD());return!0})},trigger:function(a){return this.Event.leftClick.getResult(a)}}};b.Events.onEvent={"default":function(){},Setup:{enable:function(a){var b=this;a.on("JOBAD.Event",function(a,c,f){b.Event.onEvent.trigger(c,f)})},disable:function(a){a.off("JOBAD.Event")}},namespace:{getResult:function(a,b){return this.modules.iterateAnd(function(c){c.onEvent.call(c,a,b,c.getJOBAD());return!0})},trigger:function(a,b){return this.Event.onEvent.getResult(a,b)}}};b.Events.contextMenuEntries={"default":function(){return[]},
Setup:{enable:function(a){var c=this;b.UI.ContextMenu.enable(a,function(b){var d=c.Event.contextMenuEntries.getResult(b);a.trigger("JOBAD.Event",["contextMenuEntries",b]);return d})},disable:function(a){b.UI.ContextMenu.disable(a)}},namespace:{getResult:function(a){for(var c=[],g=this.modules.iterate(function(c){c=c.contextMenuEntries.call(c,a,c.getJOBAD());return b.refs._.isArray(c)?c:b.util.generateMenuList(c)}),d=0;d<g.length;d++)for(var f=g[d],h=0;h<f.length;h++)c.push(f[h]);return 0==c.length?
!1:c}}};b.util.generateMenuList=function(a){if("undefined"==typeof a)return[];var c=[],g;for(g in a)if(a.hasOwnProperty(g)){var d=a[g];"function"==typeof d?c.push([g,d]):c.push([g,b.util.generateMenuList(d)])}return c};b.util.fullWrap=function(a,c){a=b.refs._.isArray(a)?a:b.util.generateMenuList(a);for(var g=[],d=0;d<a.length;d++)"function"==typeof a[d][1]?function(){var b=a[d][1];g.push([a[d][0],function(){return c(b,arguments)}])}():g.push([a[d][0],b.util.fullWrap(a[d][1])]);return g};b.Events.hoverText=
{"default":function(){return!1},Setup:{init:function(){this.Event.hoverText.activeHoverElement=void 0},enable:function(a){var c=this;a.delegate("*","mouseenter.JOBAD.hoverText",function(g){var d=b.refs.$(this);c.Event.hoverText.trigger(d)?g.stopPropagation():d.is(a)||b.refs.$(this).parent().trigger("mouseenter.JOBAD.hoverText",g);a.trigger("JOBAD.Event",["hoverText",d]);return!1}).delegate("*","mouseleave.JOBAD.hoverText",function(){return c.Event.hoverText.untrigger(b.refs.$(this))})},disable:function(a){"undefined"!=
typeof this.Event.hoverText.activeHoverElement&&me.Event.hoverText.untrigger();a.undelegate("*","mouseenter.JOBAD.hoverText").undelegate("*","mouseleave.JOBAD.hoverText")}},namespace:{getResult:function(a){var c=!1;this.modules.iterate(function(g){var d=g.hoverText.call(g,a,g.getJOBAD());if("undefined"!=typeof d&&"boolean"==typeof c)if("string"==typeof d)c=b.refs.$("<p>").text(d);else if("boolean"!=typeof d)try{c=b.refs.$(d)}catch(f){b.error("Module '"+g.info().identifier+"' returned invalid HOVER result. ")}else!0===
d&&(c=!0);return!0});return c},trigger:function(a){if(a.data("JOBAD.hover.Active"))return!1;var c=this.Event.hoverText.getResult(a);if("boolean"==typeof c)return c;if(this.Event.hoverText.activeHoverElement instanceof b.refs.$){if(this.Event.hoverText.activeHoverElement.is(a))return!0;this.Event.hoverText.untrigger(this.Event.hoverText.activeHoverElement)}this.Event.hoverText.activeHoverElement=a;a.data("JOBAD.hover.Active",!0);var g=window.setTimeout(function(){a.removeData("JOBAD.hover.timerId");
b.UI.hover.enable(c.html(),"JOBAD_Hover")},b.UI.hover.config.hoverDelay);a.data("JOBAD.hover.timerId",g);return!0},untrigger:function(a){if("undefined"==typeof a)if(this.Event.hoverText.activeHoverElement instanceof b.refs.$)a=this.Event.hoverText.activeHoverElement;else return!1;if(!a.data("JOBAD.hover.Active"))return!1;"number"==typeof a.data("JOBAD.hover.timerId")&&(window.clearTimeout(a.data("JOBAD.hover.timerId")),a.removeData("JOBAD.hover.timerId"));a.removeData("JOBAD.hover.Active");this.Event.hoverText.activeHoverElement=
void 0;b.UI.hover.disable();return!a.is(this.element)?(this.Event.hoverText.trigger(a.parent()),!1):!0}}};b.Events.onSideBarUpdate={"default":function(){},Setup:{init:{Sidebar:{redraw:function(){"undefined"==typeof this.Sidebar.Elements&&(this.Sidebar.Elements={});if(0==b.refs._.keys(this.Sidebar.Elements).length)this.element.data("JOBAD.UI.Sidebar.active")&&b.UI.Sidebar.unwrap(this.element);else{this.element.data("JOBAD.UI.Sidebar.active")||b.UI.Sidebar.wrap(this.element);for(var a in this.Sidebar.Elements)this.Sidebar.Elements[a].data("JOBAD.Events.Sidebar.id")||
(this.Sidebar.Elements[a]=b.UI.Sidebar.addNotification(this.element,this.Sidebar.Elements[a]))}b.UI.Sidebar.forceNotificationUpdate();this.Event.onSideBarUpdate.trigger()},registerNotification:function(a,c){var g=this;"undefined"==typeof this.Sidebar.Elements&&(this.Sidebar.Elements={});a=b.refs.$(a);var d=(new Date).getTime().toString();this.Sidebar.Elements[d]=a;this.Sidebar.redraw();var f=this.Sidebar.Elements[d].data("JOBAD.Events.Sidebar.id",d);f.data("JOBAD.Events.Sidebar.element",a);c="undefined"==
typeof c?{}:c;c.hasOwnProperty("text")&&f.text(c.text);c.trace&&f.hover(function(){b.UI.highlight(a)},function(){b.UI.unhighlight(a)});"function"==typeof c.click&&f.click(c.click);d=!1;if("string"==typeof c["class"]){var h=c["class"];b.UI.Sidebar.config.icons.hasOwnProperty(h)&&(d=b.UI.Sidebar.config.icons[h])}"string"==typeof c.icon&&(d=c.icon);"string"==typeof d?(f.html("<img src='"+d+"' width='16px' height='16px'>"),f.hover(function(){b.UI.hover.enable(b.refs.$("<div>").text(c.text).html(),"JOBAD_Sidebar_Hover JOBAD_Sidebar "+
("string"==typeof c["class"]?" JOBAD_Notification_"+c["class"]:""))},function(){b.UI.hover.disable()})):f.addClass("JOBAD_Notification_"+h);if("undefined"!=typeof c.menu){var j=b.util.fullWrap(c.menu,function(b){return b.apply(f,[a,g])});b.UI.ContextMenu.enable(f,function(){return j})}return f},removeNotification:function(a){if(a instanceof b.refs.$){var c=a.data("JOBAD.Events.Sidebar.id");b.UI.Sidebar.removeNotification(a);delete this.Sidebar.Elements[c];this.Sidebar.redraw()}else b.error("JOBAD Sidebar Error: Tried to remove invalid Element. ")}}},
enable:function(){this.Event.onSideBarUpdate.enabled=!0},disable:function(){this.Event.onSideBarUpdate.enabled=void 0}},namespace:{getResult:function(){this.Event.onSideBarUpdate.enabled&&this.modules.iterateAnd(function(a){a.onSideBarUpdate.call(a,a.getJOBAD());return!0})},trigger:function(){this.Event.onSideBarUpdate.getResult()}}};b.extensions.config={required:!1,validate:function(){return!0},init:function(a,b){return a?b:{}},onJOBADinit:function(){},onFirstLoad:function(){},onLoad:function(){}};
b.config.debug=!1;return b}();
