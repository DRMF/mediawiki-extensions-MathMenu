...
var g=(new Date).getTime().toString();this.Sidebar.Elements[g]=a;this.Sidebar.redraw();g=this.Sidebar.Elements[g].data("JOBAD.Events.Sidebar.id",g);g.data("JOBAD.Events.Sidebar.element",a);c="undefined"==typeof c?{}:c;c.hasOwnProperty("text")&&g.text(c.text);c.trace&&g.hover(function(){b.UI.highlight(a)},function(){b.UI.unhighlight(a)});"function"==typeof c.click&&g.click(c.click);var d=!1;if("string"==typeof c["class"]){var e=c["class"];b.UI.Sidebar.config.icons.hasOwnProperty(e)&&(d=b.UI.Sidebar.config.icons[e])}"string"==
typeof c.icon&&(d=c.icon);"string"==typeof d?(g.html("<img src='"+d+"' width='16px' height='16px'>"),g.hover(function(){b.UI.hover.enable(b.refs.$("<div>").text(c.text).html(),"JOBAD_Sidebar_Hover JOBAD_Sidebar "+("string"==typeof c["class"]?" JOBAD_Notification_"+c["class"]:""))},function(){b.UI.hover.disable()})):g.addClass("JOBAD_Notification_"+e);return g},removeNotification:function(a){if(a instanceof b.refs.$){var c=a.data("JOBAD.Events.Sidebar.id");b.UI.Sidebar.removeNotification(a);delete this.Sidebar.Elements[c];
