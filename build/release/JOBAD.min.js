...
e.dependencies;if(!c.refs._.isArray(f))return!1;b.info.dependencies=f}try{c.refs._.map(["identifier","title","author","description"],function(a){if(e.hasOwnProperty(a)){var c=e[a];if("string"!=typeof c)throw"";b.info[a]=c}else throw"";})}catch(g){return!1}f=["info","globalinit","init"];b.namespace={};for(d in a)a.hasOwnProperty(d)&&(-1==f.indexOf(d)&&!c.Events.hasOwnProperty(d))&&(b.info.hasCleanNamespace?c.console.warn("Warning: Module '"+b.info.identifier+"' says its namespace is clean, but property '"+
d+"' found. Check ModuleObject.info.hasCleanNamespace. "):b.namespace[d]=a[d]);for(d in c.Events)a.hasOwnProperty(d)&&(b[d]=a[d]);return b}return!1};c.modules.available=function(a,b){b="boolean"==typeof b?b:!1;var d=n.hasOwnProperty(a);if(b&&d){for(var d=n[a].info.dependencies,e=0;e<d.length;e++)if(!c.modules.available(d[e],!0))return!1;return!0}return d};c.modules.getDependencyList=function(a){if(!c.modules.available(a,!0))return!1;var b=[a];a=n[a].info.dependencies;for(var d=a.length-1;0<=d;d--)b=
c.refs._.union(b,c.modules.getDependencyList(a[d]));return b};c.modules.loadedModule=function(a,b,d){c.modules.available(a)||c.error("Module is not available and cant be loaded. ");this.globalStore={get:function(b){return l[a][b+"_"]},set:function(b,c){l[a][b+"_"]=c},"delete":function(b){delete l[a][b+"_"]}};var e={};this.localStore={get:function(a){return e[a]},set:function(a,b){e[a]=b},"delete":function(){delete e[a]}};var f=n[a];this.info=function(){return f.info};this.getJOBAD=function(){return d};
l[a].init||(l[a].init=!0,f.globalinit.apply(void 0,[]));for(var g=[d],k=0;k<b.length;k++)g.push(b[k]);if(c.config.cleanModuleNamespace)f.info.hasCleanNamespace||c.console.warn("Warning: Module '"+a+"' may have unclean namespace, but JOBAD.config.cleanModuleNamespace is true. ");else{b=c.refs._.clone(f.namespace);for(var j in b)!c.Events.hasOwnProperty(j)&&b.hasOwnProperty(j)&&(this[j]=b[j])}for(j in c.Events)this[j]=f.hasOwnProperty(j)?f[j]:c.Events[j]["default"];f.init.apply(this,g)};c.util={};c.util.bindEverything=
function(a,b){if(c.refs._.isObject(a)&&"function"!=typeof a){var d={},e;for(e in a)d[e]=c.util.bindEverything(a[e],b);return d}return"function"==typeof a?c.refs._.bind(a,b):c.refs._.clone(a)};c.refs={};c.refs.$=r;c.refs._=_;c.noConflict=function(){return{_:c.noConflict._(),$:c.noConflict.$()}};c.noConflict.$=function(){c.refs.$=c.refs.$.noConflict();return c.refs.$};c.noConflict._=function(){c.refs._=c.refs._.noConflict();return c.refs._};b=c;b.config.debug=!1;var p=[0,0];b.refs.$(document).on("mousemove.JOBADListener",
function(a){p=[a.pageX-b.refs.$(window).scrollLeft(),a.pageY-b.refs.$(window).scrollTop()]});b.UI={};b.UI.hover={};b.UI.hover.config={offsetX:10,offsetY:10};var q=!1,m=void 0;b.UI.hover.enable=function(a){q=!0;m=b.refs.$("<div class='JOBAD JOBADHover'>").html(a).css({position:"fixed","background-color":"grey","-webkit-border-radius":5,"-moz-border-radius":5,"border-radius":5,border:"1px solid black"});m.appendTo(b.refs.$("body"));b.refs.$(document).on("mousemove.JOBAD.UI.hover",function(){b.UI.hover.refresh()});
b.UI.hover.refresh();return!0};b.UI.hover.disable=function(){if(!q)return!1;q=!1;b.refs.$(document).off("mousemove.JOBAD.UI.hover");m.remove()};b.UI.hover.refresh=function(){q&&m.css("top",Math.min(p[1]+b.UI.hover.config.offsetY,window.innerHeight-m.outerHeight(!0))).css("left",Math.min(p[0]+b.UI.hover.config.offsetX,window.innerWidth-m.outerWidth(!0)))};b.UI.ContextMenu={};b.UI.ContextMenu.config={margin:20,width:250};b.UI.ContextMenu.enable=function(a,c,d,e){if("function"!=typeof c)return b.error("JOBAD.UI.ContextMenu.enable: demandFunction is not a function"),
a;"function"!=typeof d&&(d=function(){});"function"!=typeof e&&(e=function(){});a.on("contextmenu.JOBAD.UI.ContextMenu",function(f){if(f.ctrlKey)return!0;var g=b.refs.$(f.target);f=b.refs.$(f.target);for(var k=!1;!(k=c(g,f))&&!a.is(this);)g=g.parent();if(!k)return!0;b.refs.$(document).trigger("JOBADContextMenuUnbind");d(a);var j=b.UI.ContextMenu.buildMenuList(k,g,f).menu().css({width:b.UI.ContextMenu.config.width,position:"fixed"}).on("contextmenu",function(){return!1}).on("mousedown",function(a){a.stopPropagation()}).appendTo(b.refs.$("body"));
...
function(a){a.off("contextmenu.JOBAD.UI.ContextMenu");return a};b.UI.ContextMenu.buildMenuList=function(a,c,d){for(var e=b.refs.$("<ul>"),f=0;f<a.length;f++){var g=a[f],k=b.refs.$("<a href='#'>");$li=b.refs.$("<li>").appendTo(e).append(k);k.text(g[0]).on("click",function(){return!1});(function(){if("function"==typeof g[1]){var a=g[1];k.on("click",function(){b.refs.$(document).trigger("JOBADContextMenuUnbind");a(c,d)})}else $li.append(b.UI.ContextMenu.buildMenuList(g[1],c,d))})()}return e};b.UI.Sidebar=
{};b.UI.Sidebar.config={width:100};b.UI.Sidebar.wrap=function(a){a=$(a);var c=b.refs.$("<div>").css({overflow:"hidden"}),d=b.refs.$("<div>").css({"float":"right",width:b.UI.Sidebar.config.width,height:1,position:"relative"}),e=b.refs.$("<div>").css({width:"100%","float":"left",overflow:"hidden"});a.wrap(c);c=a.parent();c.wrap(e);e=c.parent();e.prepend(d);a.data("JOBAD.UI.Sidebar.active",!0);return a};b.UI.Sidebar.unwrap=function(a){a=b.refs.$(a);a.unwrap().parent().find("div").first().remove();a.removeData("JOBAD.UI.Sidebar.active");
return a.unwrap()};b.UI.Sidebar.addNotification=function(a,c){var d=b.refs.$(a),e=b.refs.$(c),f=e.offset().top-d.offset().top,d=d.parent().parent().find("div").first(),g=b.refs.$("<div>").css({position:"absolute",top:f}).appendTo(d),f=function(){var a=e.offset().top-d.offset().top;g.css({top:a})};b.refs.$(window).on("resize.JOBAD.UI.Sidebar",f);return g.data("JOBAD.UI.Sidebar.ResizeHook",f)};b.UI.Sidebar.forceNotificationUpdate=function(){b.refs.$(window).trigger("resize.JOBAD.UI.Sidebar")};b.UI.Sidebar.removeNotification=
function(a){var c=a.data("JOBAD.UI.Sidebar.ResizeHook");b.refs.$(window).off("resize.JOBAD.UI.Sidebar",c);a.remove()};b.UI.highlight=function(a){a=b.refs.$(a);a.data("JOBAD.UI.highlight.orgColor")&&a.css("backgroundColor",a.data("JOBAD.UI.highlight.orgColor"));a.stop().data("JOBAD.UI.highlight.orgColor",a.css("backgroundColor")).animate({backgroundColor:"#FFFF9C"},1E3)};b.UI.unhighlight=function(a){a=b.refs.$(a);a.stop().animate({backgroundColor:a.data("JOBAD.UI.highlight.orgColor")},1E3).removeData("JOBAD.UI.highlight.orgColor")};
b.Events.leftClick={"default":function(){return!1},Setup:{enable:function(a){var c=this;a.delegate("*","click.JOBAD.leftClick",function(a){var e=b.refs.$(a.target);switch(a.which){case 1:c.Event.leftClick.trigger(e),a.stopPropagation()}})},disable:function(a){a.undelegate("*","click.JOBAD.leftClick")}},namespace:{getResult:function(a){return this.modules.iterateAnd(function(b){b.leftClick.call(b,a,b.getJOBAD());return!0})},trigger:function(a){return this.Event.leftClick.getResult(a)}}};b.Events.contextMenuEntries=
{"default":function(){return[]},Setup:{enable:function(a){var c=this;b.UI.ContextMenu.enable(a,function(a){return c.Event.contextMenuEntries.getResult(a)})},disable:function(a){b.UI.ContextMenu.disable(a)}},namespace:{getResult:function(a){for(var c=[],d=this.modules.iterate(function(c){c=c.contextMenuEntries.call(c,a,c.getJOBAD());return b.refs._.isArray(c)?c:b.util.generateMenuList(c)}),e=0;e<d.length;e++)for(var f=d[e],g=0;g<f.length;g++)c.push(f[g]);return 0==c.length?!1:c}}};b.util.generateMenuList=
