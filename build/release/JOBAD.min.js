...
c.refs._.noConflict();return c.refs._};b=c;b.config.debug=!1;var p=[0,0];b.refs.$(document).on("mousemove.JOBADListener",function(a){p=[a.pageX-b.refs.$(window).scrollLeft(),a.pageY-b.refs.$(window).scrollTop()]});b.UI={};b.UI.hover={};b.UI.hover.config={offsetX:10,offsetY:10};var q=!1,m=void 0;b.UI.hover.enable=function(a){q=!0;m=b.refs.$("<div class='JOBAD JOBADHover'>").html(a).css({position:"fixed","background-color":"grey","-webkit-border-radius":5,"-moz-border-radius":5,"border-radius":5,border:"1px solid black"});
...
k.on("click",function(){b.refs.$(document).trigger("JOBADContextMenuUnbind");a(c,d)})}else $li.append(b.UI.ContextMenu.buildMenuList(g[1],c,d))})()}return e};b.UI.Sidebar={};b.UI.Sidebar.config={width:100};b.UI.Sidebar.wrap=function(a){a=$(a);var c=b.refs.$("<div>").css({overflow:"hidden"}),d=b.refs.$("<div>").css({"float":"right",width:b.UI.Sidebar.config.width,height:1,position:"relative"}),e=b.refs.$("<div>").css({width:"100%","float":"left",overflow:"hidden"});a.wrap(c);c=a.parent();c.wrap(e);
e=c.parent();e.prepend(d);a.data("JOBAD.UI.Sidebar.active",!0);return a};b.UI.Sidebar.unwrap=function(a){a=b.refs.$(a);a.unwrap().parent().find("div").first().remove();a.removeData("JOBAD.UI.Sidebar.active");return a.unwrap()};b.UI.Sidebar.addNotification=function(a,c){var d=b.refs.$(a),e=b.refs.$(c),f=e.offset().top-d.offset().top,d=d.parent().parent().find("div").first(),g=b.refs.$("<div>").css({position:"absolute",top:f}).appendTo(d),f=function(){var a=e.offset().top-d.offset().top;g.css({top:a})};
b.refs.$(window).on("resize.JOBAD.UI.Sidebar",f);return g.data("JOBAD.UI.Sidebar.ResizeHook",f)};b.UI.Sidebar.forceNotificationUpdate=function(){b.refs.$(window).trigger("resize.JOBAD.UI.Sidebar")};b.UI.Sidebar.removeNotification=function(a){var c=a.data("JOBAD.UI.Sidebar.ResizeHook");b.refs.$(window).off("resize.JOBAD.UI.Sidebar",c);a.remove()};b.UI.highlight=function(a){a=b.refs.$(a);a.data("JOBAD.UI.highlight.orgColor")&&a.css("backgroundColor",a.data("JOBAD.UI.highlight.orgColor"));a.stop().data("JOBAD.UI.highlight.orgColor",
a.css("backgroundColor")).animate({backgroundColor:"#FFFF9C"},1E3)};b.UI.unhighlight=function(a){a=b.refs.$(a);a.stop().animate({backgroundColor:a.data("JOBAD.UI.highlight.orgColor")},1E3).removeData("JOBAD.UI.highlight.orgColor")};b.Events.leftClick={"default":function(){return!1},Setup:{enable:function(a){var c=this;a.delegate("*","click.JOBAD.leftClick",function(a){var e=b.refs.$(a.target);switch(a.which){case 1:c.Event.leftClick.trigger(e),a.stopPropagation()}})},disable:function(a){a.undelegate("*",
