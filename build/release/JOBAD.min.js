...
*/
var JOBAD=function(){var b,c=function(a){if(!(this instanceof c))return new c(a);var f=this;this.element=a;c.refs._.isElement(this.element)&&(this.element=c.refs.$(this.element));this.element instanceof c.refs.$||c.error("Can't create JOBADInstance: Not a DOM Element. ");var b={},d=[];this.modules={};this.modules.load=function(a,d,e){if(!f.modules.loaded(a)){if("boolean"==typeof e&&e)c.modules.available(a)||c.error("Error loading module "+a),b[a]=new c.modules.loadedModule(a,d,f);else{e=c.modules.getDependencyList(a);
if(!e)return c.console.warn("Unresolved dependencies for module '"+a+"'. "),!1;for(a=0;a<e.length;a++)f.modules.load(e[a],d,!0)}return!0}};this.modules.loaded=function(a){return b.hasOwnProperty(a)};this.modules.deactivate=function(a){f.modules.isActive(a)?c.warn("Module '"+a+"' is already deactivated. "):d.push(a)};this.modules.activate=function(a){f.modules.isActive(a)?c.warn("Module '"+a+"' is already activated. "):d=c.refs._.without(d,a)};this.modules.isActive=function(a){return-1==c.refs._.indexOf(d,
a)};this.modules.iterate=function(a){var d=[],c;for(c in b)if(b.hasOwnProperty(c)&&f.modules.isActive(c)){var e=a(b[c]);if(e)d.push(e);else break}return d};this.modules.iterateAnd=function(a){for(var d in b)if(b.hasOwnProperty(d)&&f.modules.isActive(d)&&!a(b[d]))return!1;return!0};this.Event={};this.Setup=function(){return f.Setup.enable()};this.Setup.enable=function(){var a=f.element,b;for(b in f.Event)c.Events[b].Setup.enable.call(f,a);return!0};this.Setup.disable=function(){return!1};for(var e in c.Events)if(c.Events.hasOwnProperty(e)&&
!c.isEventDisabled(e))if(f.Event[e]=c.util.bindEverything(c.Events[e].namespace,f),"function"==typeof c.Events[e].Setup.init)c.Events[e].Setup.init.call(f,f);else if("object"==typeof c.Events[e].Setup.init)for(var h in c.Events[e].Setup.init)c.Events[e].Setup.init.hasOwnProperty(h)&&(f.hasOwnProperty(h)?c.console.warn("Setup: Event '"+e+"' tried to override '"+h+"'"):f[h]=c.util.bindEverything(c.Events[e].Setup.init[h],f))};c.version="3.0.0";c.config={debug:!0,cleanModuleNamespace:!1,disabledEvents:[]};
c.Events={};c.isEventDisabled=function(a){return-1!=c.config.disabledEvents.indexOf(a)};c.console=_.isUndefined(console)?{log:function(){},warn:function(){},error:function(){}}:{log:function(a){c.config.debug&&console.log(a)},warn:function(a){c.config.debug&&console.warn(a)},error:function(a){c.config.debug&&console.error(a)}};c.error=function(a){c.console.error(a);throw Error(a);};c.modules={};var n={},l={};c.modules.register=function(a){a=c.modules.createProperModuleObject(a);if(!a)return!1;var f=
a.info.identifier;if(c.modules.available(f))return!1;n[f]=a;l[f]={};return!0};c.modules.createProperModuleObject=function(a){if(!c.refs._.isObject(a))return!1;var f={globalinit:function(){},init:function(){}},b;for(b in f)if(f.hasOwnProperty(b)&&a.hasOwnProperty(b)){if("function"!=typeof a[b])return!1;f[b]=a[b]}if(a.hasOwnProperty("info")){var d=a.info;f.info={version:"",dependencies:[]};if(d.hasOwnProperty("version")){if("string"!=typeof d.version)return!1;f.info.version=d.version}f.info.hasCleanNamespace=
d.hasOwnProperty("hasCleanNamespace")?!1==d.hasCleanNamespace?!1:!0:!0;if(d.hasOwnProperty("dependencies")){var e=d.dependencies;if(!c.refs._.isArray(e))return!1;f.info.dependencies=e}try{c.refs._.map(["identifier","title","author","description"],function(a){if(d.hasOwnProperty(a)){var b=d[a];if("string"!=typeof b)throw"";f.info[a]=b}else throw"";})}catch(h){return!1}e=["info","globalinit","init"];f.namespace={};for(b in a)a.hasOwnProperty(b)&&(-1==e.indexOf(b)&&!c.Events.hasOwnProperty(b))&&(f.info.hasCleanNamespace?
c.console.warn("Warning: Module '"+f.info.identifier+"' says its namespace is clean, but property '"+b+"' found. Check ModuleObject.info.hasCleanNamespace. "):f.namespace[b]=a[b]);for(b in c.Events)a.hasOwnProperty(b)&&(f[b]=a[b]);return f}return!1};c.modules.available=function(a,b){b="boolean"==typeof b?b:!1;var g=n.hasOwnProperty(a);if(b&&g){for(var g=n[a].info.dependencies,d=0;d<g.length;d++)if(!c.modules.available(g[d],!0))return!1;return!0}return g};c.modules.getDependencyList=function(a){if(!c.modules.available(a,
!0))return!1;var b=[a];a=n[a].info.dependencies;for(var g=a.length-1;0<=g;g--)b=c.refs._.union(b,c.modules.getDependencyList(a[g]));return b};c.modules.loadedModule=function(a,b,g){c.modules.available(a)||c.error("Module is not available and cant be loaded. ");this.globalStore={get:function(b){return l[a][b+"_"]},set:function(b,f){l[a][b+"_"]=f},"delete":function(b){delete l[a][b+"_"]}};var d={};this.localStore={get:function(a){return d[a]},set:function(a,b){d[a]=b},"delete":function(){delete d[a]}};
var e=n[a];this.info=function(){return e.info};this.getJOBAD=function(){return g};l[a].init||(l[a].init=!0,e.globalinit.apply(void 0,[]));for(var h=[g],k=0;k<b.length;k++)h.push(b[k]);if(c.config.cleanModuleNamespace)e.info.hasCleanNamespace||c.console.warn("Warning: Module '"+a+"' may have unclean namespace, but JOBAD.config.cleanModuleNamespace is true. ");else{b=c.refs._.clone(e.namespace);for(var j in b)!c.Events.hasOwnProperty(j)&&b.hasOwnProperty(j)&&(this[j]=b[j])}for(j in c.Events)this[j]=
e.hasOwnProperty(j)?e[j]:c.Events[j]["default"];e.init.apply(this,h)};c.util={};c.util.bindEverything=function(a,b){if(c.refs._.isObject(a)&&"function"!=typeof a){var g={},d;for(d in a)g[d]=c.util.bindEverything(a[d],b);return g}return"function"==typeof a?c.refs._.bind(a,b):c.refs._.clone(a)};c.refs={};c.refs.$=jQuery;c.refs._=_;c.noConflict=function(){return{_:c.noConflict._(),$:c.noConflict.$()}};c.noConflict.$=function(){c.refs.$=c.refs.$.noConflict();return c.refs.$};c.noConflict._=function(){c.refs._=
...
b.UI.Sidebar.wrap=function(a){a=$(a);var f=b.refs.$("<div>").css({overflow:"hidden"}),c=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Container'>").css({width:b.UI.Sidebar.config.width}),d=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Wrapper'>");a.wrap(f);f=a.parent();f.wrap(d);d=f.parent();d.prepend(c);a.data("JOBAD.UI.Sidebar.active",!0);return a};b.UI.Sidebar.unwrap=function(a){a=b.refs.$(a);a.unwrap().parent().find("div").first().remove();a.removeData("JOBAD.UI.Sidebar.active");
return a.unwrap()};b.UI.Sidebar.addNotification=function(a,f){var c=b.refs.$(a),d=b.refs.$(f),e=d.offset().top-c.offset().top,c=c.parent().parent().find("div").first(),h=b.refs.$("<div class='JOBAD JOBAD_Sidebar JOBAD_Sidebar_Notification'>").css({top:e}).appendTo(c),e=function(){var a=d.offset().top-c.offset().top;h.css({top:a})};b.refs.$(window).on("resize.JOBAD.UI.Sidebar",e);return h.data("JOBAD.UI.Sidebar.ResizeHook",e)};b.UI.Sidebar.forceNotificationUpdate=function(){b.refs.$(window).trigger("resize.JOBAD.UI.Sidebar")};
b.UI.Sidebar.removeNotification=function(a){var f=a.data("JOBAD.UI.Sidebar.ResizeHook");b.refs.$(window).off("resize.JOBAD.UI.Sidebar",f);a.remove()};b.UI.highlight=function(a){a=b.refs.$(a);var f;f="string"==typeof a.data("JOBAD.UI.highlight.orgColor")?a.data("JOBAD.UI.highlight.orgColor"):a.css("backgroundColor");a.stop().data("JOBAD.UI.highlight.orgColor",f).animate({backgroundColor:"#FFFF9C"},1E3)};b.UI.unhighlight=function(a){a=b.refs.$(a);a.stop().animate({backgroundColor:a.data("JOBAD.UI.highlight.orgColor"),
finish:function(){a.removeData("JOBAD.UI.highlight.orgColor")}},1E3)};b.Events.leftClick={"default":function(){return!1},Setup:{enable:function(a){var f=this;a.delegate("*","click.JOBAD.leftClick",function(c){var d=b.refs.$(c.target);switch(c.which){case 1:f.Event.leftClick.trigger(d),c.stopPropagation()}a.trigger("JOBAD.Event",["leftClick",d])})},disable:function(a){a.undelegate("*","click.JOBAD.leftClick")}},namespace:{getResult:function(a){return this.modules.iterateAnd(function(b){b.leftClick.call(b,
a,b.getJOBAD());return!0})},trigger:function(a){return this.Event.leftClick.getResult(a)}}};b.Events.onEvent={"default":function(){},Setup:{enable:function(a){var b=this;a.on("JOBAD.Event",function(a,c,e){b.Event.onEvent.trigger(c,e)})},disable:function(a){a.off("JOBAD.Event")}},namespace:{getResult:function(a,b){return this.modules.iterateAnd(function(c){c.onEvent.call(c,a,b,c.getJOBAD());return!0})},trigger:function(a,b){return this.Event.onEvent.getResult(a,b)}}};b.Events.contextMenuEntries={"default":function(){return[]},
Setup:{enable:function(a){var c=this;b.UI.ContextMenu.enable(a,function(b){var d=c.Event.contextMenuEntries.getResult(b);a.trigger("JOBAD.Event",["contextMenuEntries",b]);return d})},disable:function(a){b.UI.ContextMenu.disable(a)}},namespace:{getResult:function(a){for(var c=[],g=this.modules.iterate(function(c){c=c.contextMenuEntries.call(c,a,c.getJOBAD());return b.refs._.isArray(c)?c:b.util.generateMenuList(c)}),d=0;d<g.length;d++)for(var e=g[d],h=0;h<e.length;h++)c.push(e[h]);return 0==c.length?
...
(this.Sidebar.Elements[a]=b.UI.Sidebar.addNotification(this.element,this.Sidebar.Elements[a]))}b.UI.Sidebar.forceNotificationUpdate();this.Event.onSideBarUpdate.trigger()},registerNotification:function(a,c){var g=this;"undefined"==typeof this.Sidebar.Elements&&(this.Sidebar.Elements={});a=b.refs.$(a);var d=(new Date).getTime().toString();this.Sidebar.Elements[d]=a;this.Sidebar.redraw();var e=this.Sidebar.Elements[d].data("JOBAD.Events.Sidebar.id",d);e.data("JOBAD.Events.Sidebar.element",a);c="undefined"==
typeof c?{}:c;c.hasOwnProperty("text")&&e.text(c.text);c.trace&&e.hover(function(){b.UI.highlight(a)},function(){b.UI.unhighlight(a)});"function"==typeof c.click&&e.click(c.click);d=!1;if("string"==typeof c["class"]){var h=c["class"];b.UI.Sidebar.config.icons.hasOwnProperty(h)&&(d=b.UI.Sidebar.config.icons[h])}"string"==typeof c.icon&&(d=c.icon);"string"==typeof d?(e.html("<img src='"+d+"' width='16px' height='16px'>"),e.hover(function(){b.UI.hover.enable(b.refs.$("<div>").text(c.text).html(),"JOBAD_Sidebar_Hover JOBAD_Sidebar "+
("string"==typeof c["class"]?" JOBAD_Notification_"+c["class"]:""))},function(){b.UI.hover.disable()})):e.addClass("JOBAD_Notification_"+h);if("undefined"!=typeof c.menu){var k=b.util.fullWrap(c.menu,function(b){return b.apply(e,[a,g])});b.UI.ContextMenu.enable(e,function(){return k})}return e},removeNotification:function(a){if(a instanceof b.refs.$){var c=a.data("JOBAD.Events.Sidebar.id");b.UI.Sidebar.removeNotification(a);delete this.Sidebar.Elements[c];this.Sidebar.redraw()}else b.error("JOBAD Sidebar Error: Tried to remove invalid Element. ")}}},
enable:function(){this.Event.onSideBarUpdate.enabled=!0},disable:function(){this.Event.onSideBarUpdate.enabled=void 0}},namespace:{getResult:function(){this.Event.onSideBarUpdate.enabled&&this.modules.iterateAnd(function(a){a.onSideBarUpdate.call(a,a.getJOBAD());return!0})},trigger:function(){this.Event.onSideBarUpdate.getResult()}}};b.config.debug=!1;return b}();
